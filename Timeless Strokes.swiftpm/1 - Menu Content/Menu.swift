    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                .background(
                    NavigationLink("", destination: StoryContextD1View(), isActive: $isNavigatingToStoryContext)
                        .opacity(0)
                )
                ...
                .position(x: UIScreen.main.bounds.width - 85, y: UIScreen.main.bounds.height - 50)
                .background(
